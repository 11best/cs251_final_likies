    ...
    <div class="main">     
        <div class="upperbar">
            ...
            <?php if(isset($_SESSION['username'])) :?>
                ...
                <a href="index.php?logout='1'"> <img alt="logout" src="icon/log-out.png" width="20px" style="padding: 0;top: 4px; position: relative;padding-right: 10px;z-index: 3;"> </a>
            <?php endif ?>
        ...
        <div class=content>
            <a href="upload.php"><img src="icon/plus.png" ><br>New</a>
        </div>
        ...
        <?php 
            ...
            $all = "SELECT record.* , entertainment.E_name, entertainment.C_name
                    FROM entertainment 
                    INNER JOIN record
                    ON record.E_ID = entertainment.E_ID AND record.U_ID = (SELECT U_ID FROM member WHERE username = '$Uname')
