...
<body>
    ...
    <div class="upperbar">
        ...
        <div class="page_info">
            <p>All of cartoon that you like.</p>
        </div>
        ...
        <?php 
            ...
            $all = "SELECT record.* , entertainment.E_name, entertainment.C_name
                    FROM entertainment 
                    INNER JOIN record
                    ON record.E_ID = entertainment.E_ID AND record.U_ID = (SELECT U_ID FROM member WHERE username = '$Uname') AND entertainment.C_name = 'Cartoon'
